...
class ECTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontSizeMd, color: ColorPalette.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontSizeSm, color: ColorPalette.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    hintStyle: const TextStyle()
        .copyWith(fontSize: AppSizes.fontSizeSm, color: ColorPalette.white),
    floatingLabelStyle:
